...
import com.ak.anima.databinding.ActivityMediaBinding
import com.ak.anima.ui.adapter.pager.MediaPagerAdapter
import com.ak.anima.ui.base.activity.BaseDetailActivity
    ...
    override fun setObservers() {
        viewModel.mediaLiveData.observe(this, { media ->
            media?.run {
                ...
                DataBinding.setImage(binding.customCover.mediaCover, cover)
